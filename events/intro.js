    ...
    if (message.channel.id === '863467182061912065') {
      ...
      for (let data of raw) {
        ...
        if ((data[0]).toLowerCase() == 'siapa nama kamu') {
          ...
          domisili = data[1];
        } else if ((data[0]).toLowerCase() == 'apa profesi kamu saat ini') {
          profesi = data[1];
      ...
      if (name === '' || domisili === '' || profesi === '' || institusi === '' || hobi === '' || referral === '') {
        ...
        await message.react('✅');
        await message.channel.send(`Terima kasih ${message.author}, sudah memperkenalkan diri sesuai format. Salam kenal dan selamat bergabung yah!`);
